...
var I18n = (() => {
  ...
  const dict = {
    ...
    'compress.contentSize': { en: 'Content Size', zh: '内容大小' },
    'compress.noFrameCRC': { en: 'No Frame CRC', zh: '禁用帧校验' },
    'compress.level': { en: 'Level', zh: '压缩级别' },
    'compress.dictionary': { en: 'Dictionary (optional)', zh: '字典文件 (可选)' },
    'compress.selectDict': { en: 'Select Dictionary', zh: '选择字典' },
    'compress.noDict': { en: 'None selected', zh: '未选择' },
    'compress.process': { en: '▶ Process', zh: '▶ 开始处理' },
    ...
    'result.files': { en: 'files', zh: '个文件' },
    'result.total': { en: 'total', zh: '总计' },
    'result.fileName': { en: 'File Name', zh: '文件名' },
    'result.downloadAll': { en: 'Download All', zh: '全部下载' },
    'result.testing': { en: 'Testing integrity...', zh: '正在测试完整性...' },
    'result.testResults': { en: 'Integrity Test Results', zh: '完整性测试结果' },
    'result.status': { en: 'Status', zh: '状态' },
